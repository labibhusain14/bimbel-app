    ...
    <div className="min-h-screen flex flex-col bg-gray-100">
      ...
      <nav className="bg-white px-5 py-3 flex items-center justify-between shadow-sm relative z-50">
        ...
        <div className="hidden md:flex items-center gap-6 lg:gap-8">
          <Link href="/programs" className="text-gray-600 hover:text-purple-600 text-sm font-medium transition-colors">Programs</Link>
          <Link href="/tutors"   className="text-gray-600 hover:text-purple-600 text-sm font-medium transition-colors">Tutors</Link>
        ...
        <button
          ...
          className="md:hidden flex flex-col gap-1.5 p-1 rounded focus:outline-none"
        ...
        {menuOpen && (
          <div className="md:hidden absolute top-full left-0 right-0 bg-white border-t border-gray-100 shadow-lg px-5 py-4 flex flex-col gap-4">
            <Link href="/programs" className="text-gray-700 hover:text-purple-600 text-sm font-medium" onClick={() => setMenuOpen(false)}>Programs</Link>
            <Link href="/tutors"   className="text-gray-700 hover:text-purple-600 text-sm font-medium" onClick={() => setMenuOpen(false)}>Tutors</Link>
            <Link href="/pricing"  className="text-gray-700 hover:text-purple-600 text-sm font-medium" onClick={() => setMenuOpen(false)}>Pricing</Link>
        ...
        <div className="w-full max-w-4xl bg-white rounded-2xl shadow-lg overflow-hidden flex flex-col md:flex-row">
          ...
          <div className="flex-1 px-6 py-8 sm:px-8 sm:py-10 md:px-12 flex flex-col justify-center">
            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-4">
              ...
              <button
                type="submit"
                className="w-full bg-purple-600 hover:bg-purple-700 active:bg-purple-800 text-white font-semibold py-3 rounded-lg transition-all duration-200 flex items-center justify-center gap-2 shadow-md hover:shadow-lg text-sm sm:text-base"
              >
                Masuk
                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <button
              type="button"
              className="w-full border border-gray-300 hover:border-gray-400 hover:bg-gray-50 text-gray-700 font-medium py-3 rounded-lg transition-all duration-200 flex items-center justify-center gap-3 text-sm"
            >
          ...
          {/* Right — Purple Banner (hidden on mobile, shown md+) */}
          <div className="hidden md:flex w-[44%] bg-purple-600 flex-col items-center justify-center p-8 lg:p-10 relative overflow-hidden">
            ...
            <div className="relative z-10 bg-white/10 backdrop-blur-sm border border-white/20 rounded-2xl p-6 lg:p-8 text-center text-white max-w-xs shadow-xl">
              ...
              <h2 className="text-xl lg:text-2xl font-extrabold leading-snug mb-3">
                Empowering Creative<br />Minds.
              </h2>
              <p className="text-xs lg:text-sm text-white/80 leading-relaxed">
                Bergabunglah dengan komunitas pembelajaran modern kami. Temukan tutor terbaik untuk mengembangkan potensi mistis dan kreatif Anda.
              </p>
            </div>
          </div>

          {/* Mobile-only purple banner strip (shown below form on small screens) */}
          <div className="md:hidden bg-purple-600 px-6 py-8 flex flex-col items-center text-center text-white relative overflow-hidden">
            ...
            <div className="relative z-10 bg-white/10 border border-white/20 rounded-xl p-5 max-w-sm">
              ...
              <p className="text-xs text-white/80 leading-relaxed">
                Bergabunglah dengan komunitas pembelajaran modern kami. Temukan tutor terbaik untuk mengembangkan potensi Anda.
              </p>
            </div>
          </div>
        </div>
      ...
      <footer className="bg-white border-t border-gray-100 px-5 py-4 sm:py-5">
        <div className="max-w-5xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-3 sm:gap-4">
          ...
          <p className="text-xs sm:text-sm text-gray-400 text-center sm:text-right">© 2026 GhaitsmaratEdu.</p>
        </div>
      </footer>
    </div>
  );
