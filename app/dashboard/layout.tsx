...
const navItems = [
  ...
  },
  {
    ...
    label: "Tugas", href: "/dashboard/tugas", badge: 12,
  },
  {
    icon: <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 17h5l-1.405-1.405A2.032 2.032 0 0118 14.158V11a6.002 6.002 0 00-4-5.659V5a2 2 0 10-4 0v.341C7.67 6.165 6 8.388 6 11v3.159c0 .538-.214 1.055-.595 1.436L4 17h5m6 0v1a3 3 0 11-6 0v-1m6 0H9" /></svg>,
    label: "Pengumuman", href: "/dashboard/pengumuman", badge: 3,
  },
  {
...
export default function DashboardLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex">
        ...
        <header className="bg-white border-b border-gray-100 sticky top-0 z-40 px-4 sm:px-6 py-3 flex items-center gap-3">
          ...
          <div className="flex-1 max-w-md">
            <div className="flex items-center bg-gray-100 rounded-xl px-3 py-2 gap-2">
              ...
              <input type="text" placeholder="Cari kelas, tugas, atau pengumuman..." className="bg-transparent text-sm text-gray-700 outline-none w-full placeholder-gray-400" />
            </div>
          </div>
      ...
      {/* Bottom nav mobile */}
      <nav className="md:hidden fixed bottom-0 left-0 right-0 bg-white border-t border-gray-100 shadow-lg z-40 px-2 py-2 flex items-center justify-around">
