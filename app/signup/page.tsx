...
export default function SignupPage() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    console.log("Register attempted:", form);
  };
      ...
      <main className="flex-1 flex items-start sm:items-center justify-center px-4 py-6 sm:py-10">
        <div className="w-full max-w-4xl bg-white rounded-2xl shadow-lg overflow-hidden flex flex-col md:flex-row">
          ...
          <div className="flex-1 px-6 py-8 sm:px-8 sm:py-10 md:px-12 flex flex-col justify-center">
            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-4">
              ...
              <div className="flex flex-col gap-1.5">
                ...
                <div className={`flex items-center border rounded-lg px-3 py-2.5 gap-2 focus-within:ring-2 transition-all ${
                  form.confirmPassword && form.confirmPassword !== form.password
                    ? "border-red-400 focus-within:ring-red-100"
                    : "border-gray-300 focus-within:border-purple-500 focus-within:ring-purple-100"
                }`}>
                  <svg className="w-4 h-4 text-gray-400 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <label className="flex items-start gap-2.5 cursor-pointer mt-1">
                <input type="checkbox" required className="mt-0.5 accent-purple-600 w-4 h-4 shrink-0" />
                <span className="text-xs text-gray-500 leading-relaxed">
                  Saya menyetujui{" "}
                  <Link href="/terms" className="text-purple-600 hover:underline font-medium">Syarat & Ketentuan</Link>{" "}
                  dan{" "}
                  <Link href="/privacy" className="text-purple-600 hover:underline font-medium">Kebijakan Privasi</Link>
                </span>
              </label>
            ...
            {/* Google Register */}
            <button type="button" className="w-full border border-gray-300 hover:border-gray-400 hover:bg-gray-50 text-gray-700 font-medium py-3 rounded-lg transition-all duration-200 flex items-center justify-center gap-3 text-sm">
            ...
            <div className="relative z-10 text-center text-white">
              ...
              <div className="flex flex-col gap-5 mb-8">
                {[
                  ...
                  { step: "3", title: "Mulai Belajar", desc: "Bimbing oleh tutor terbaik" },
                ].map((s) => (
                  <div key={s.step} className="flex items-center gap-4 text-left">
                    <div className="w-9 h-9 rounded-full bg-white/20 border-2 border-white/40 flex items-center justify-center font-extrabold text-sm shrink-0">
                      {s.step}
                    </div>
                    <div>
          ...
          <div className="md:hidden bg-purple-600 px-6 py-7 text-white relative overflow-hidden">
            ...
            <div className="relative z-10 flex flex-col sm:flex-row gap-4 items-center justify-center text-center">
              {[
                { step: "1", title: "Daftar Gratis" },
                { step: "2", title: "Pilih Program" },
                { step: "3", title: "Mulai Belajar" },
              ].map((s) => (
